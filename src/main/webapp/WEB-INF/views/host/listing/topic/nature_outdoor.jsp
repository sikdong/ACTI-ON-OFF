...
<!--  				(input[name="b_topic" type="radio" value=""])*11 -->
			<table>
			<tr>
			<td><input type="radio" name="b_topic" value="배낭 여행">배낭 여행</td>
		  	<td><input type="radio" name="b_topic" value="캠핑">캠핑</td>
		  	<td><input type="radio" name="b_topic" value="하이킹">하이킹</td>
		  	<tr>
			<td><input type="radio" name="b_topic" value="화초 및 농업">화초 및 농업</td>
