...
<!--  				(input[name="b_topic" type="radio" value=""])*11 -->
			<table>
			<tr>
			<td><input type="radio" name="b_topic" value="불꽃놀이">불꽃놀이</td>
		  	<td><input type="radio" name="b_topic" value="코미디">코미디</td>
		  	<td><input type="radio" name="b_topic" value="댄스">댄스</td>
		  	</tr>
		  	<tr>
		  	<td><input type="radio" name="b_topic" value="게임">게임</td>
		  	<td><input type="radio" name="b_topic" value="마술">마술</td>
