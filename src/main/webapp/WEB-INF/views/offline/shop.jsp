...
<link rel="stylesheet" type="text/css"
	href="https://vendor-cdn.imweb.me/fonts/pretendard/web/variable/pretendardvariable.css?1669614457">
<link rel="stylesheet" type="text/css"
	href="https://vendor-cdn.imweb.me/fonts/pretendard/web/static/pretendard.css?1669614457">
<link rel="stylesheet" type="text/css"
...
<script>
	...
	var MENU_SNS_INIT_DATA = {
		...
		"_body" : "",
		"_post_url" : "https:\/\/onoffline.imweb.me\/shop_view\/?idx=2",
		"_img" : "https:\/\/cdn.imweb.me\/thumbnail\/20190919\/2276438f9ed5d.png",
		"_security_post_url" : "aHR0cHM6Ly9vbm9mZmxpbmUuaW13ZWIubWUvc2hvcF92aWV3Lz9pZHg9Mg=="
	};
...
<body
	class="doz_sys  _body_menu_m20221128551e9c60c13fa  shop_view  new_header_site"
	style="" id="doz_body">
	...
	<ul class="dropdown-menu animation-dock member_profile"
		...
		<li class="profile-footer btn-group-justified"><a
			...
			href="/logout.cm?back_url=L3Nob3Bfdmlldy8%2FaWR4PTI%3D"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<div class="viewport-nav mobile _menu_wrap "
					...
					<div class="profile-area">
						<a href="javascript:;"
							onclick="SITE_MEMBER.openLogin('L3Nob3Bfdmlldy8%2FaWR4PTI%3D', 'null', null, 'Y');"
													...
													<div>
														<div class="inline-blocked login_btn_item ">
															<a
																...
																href="javascript:;"
																onclick="SITE_MEMBER.openLogin('L3Nob3Bfdmlldy8%2FaWR4PTI%3D', 'null', null, 'N');"
														...
														<div class="site_prod_nav_wrap _prod_detail_tab_fixed"
															...
															<ul class="site_nav site_prod_nav">
																<li
																	...
																	<a class="_detail body_font_color_30 active"
																...
																<li
																	...
																	<a class="_review body_font_color_30"
...
#prod_deliv_setting .select_wrap {
	display: none;
									...
									<div class="buy_btns pc clearfix    talkpay_pc">
										<div class="buy_footer_fixed _buy_footer_fixed">
											<div class="_buy_footer_wrap"
												...
												<!-- 판매가 세팅 시작 -->
												<!--    <a class="btn cart _btn_cart" onclick="SITE_SHOP_DETAIL.showPCOptions('cart');"><i aria-hidden="true" class="simple im-icon im-ico-cart text-18"></i> 장바구니</a>                                                         -->
												<div class="clearfix" style="position: absolute; top: 15px;">
													<div class="float_l style_b_left_pc">
														<div class="_footer_price_wrap footer-price-wrap"
															...
															<span class="_pay_org_label pay_label body_font_color_50"
																style="display: none;"></span><span
																class="_pay_org_number pay_number holder total_price"
																style="font-size: 20px; display: none;"></span><span
																class="_pay_label pay_label body_font_color_50" style="">총
																상품금액(1개)</span><span
									...
									<div class="buy_btns mobile _mobile_action_btn_wrap">
										<div class="cart_btn  " style="">
											...
											<div class="pay-box no-pay-btn  ">
												...
												<a class="btn opt buy bg-brand _btn_buy" href="javascript:;"
													onclick="SITE_MEMBER.openLogin('L3Nob3Bfdmlldy8%2FaWR4PTI%3D','payment',function(){SITE_SHOP_DETAIL.addOrder('normal', 'https://onoffline.imweb.me/shop_view/?idx=2')}, 'N', 'payment');">구매하기</a>
											</div>
						...
						<div class="categorize review-box" style="padding-top: 0;">
							<div class="_detail_detail_wrap fr-view" id="fixed_tab">
								<div class="underline_tab">
									...
									<div class="spacer"
										style="display: none; width: 989.608px; height: 42.9902px; float: none;"></div>

								</div>
							</div>
							<div class="detail_detail_wrap">
								<a class="prod_detail_detail _prod_detail_tab_target is_target"
							...
							<div class="detail_review_wrap">
								<div class="_detail_review_wrap" id="first_review">
									<a class="prod_detail_review _prod_detail_tab_target is_target"
							...
							<div class="detail_qna_wrap">
								<div class="_detail_qna_wrap " id="first_qna">
									<a class="prod_detail_qna _prod_detail_tab_target is_target"
				...
				<div tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
					aria-hidden="false" class="modal in modal_site_alert site_modal"
												...
												<div>
													<p style="font-size: 12px; opacity: 0.6;">
														<span style="color: rgb(238, 238, 238);">&nbsp;CEO:
															...
															Sales Business Report: 0000-Seoul-0000</span><br> <span
															style="color: rgb(238, 238, 238);">Address: Seoul,
															Korea CS: +82 (0)0-000-0000(AM10 - PM5, Lunch PM1 - PM2,
															Weekend and Holiday Off)&nbsp;</span><br> <br> <a
															href="?mode=policy"><span
	...
	<script>
		$(function() {
			SITE_VISIT_LOG
					.addVisitLog(
							document.referrer,
							'Fjpn5GTlD7i6utaQE8QvR3FENq7kUuC6VrEtpZPmr5KzAMLjruFx1J3vW14SQSbQBT8GJ2TPXQ/Yr4ZI82NnsPCsFtfyui02CTbvzh49fDHmabYkg5CzisZphYLqd9zJ',
							'6912', 'm20221128551e9c60c13fa');
		});
	</script>
	<script>
		ALARM_MENU.init();
